...
fun AppCompatActivity.showMessage(
    ...
    MaterialDialog(this)
        ...
        .show {
            ...
            getActionButton(WhichButton.POSITIVE).updateTextColor(ColorUtils.getColor(R.color.purple_500))
            getActionButton(WhichButton.NEGATIVE).updateTextColor(ColorUtils.getColor(R.color.purple_500))
        }
}
